...
import { X, User, Calendar, CreditCard, ChevronRight } from "lucide-react";
...
export default function MembersPage() {
    ...
    const handleAssignPlan = async () => {
        ...
        try {
            ...
            // Calculate Expiry
            const now = new Date();
            const expiryDate = new Date(now.setMonth(now.getMonth() + plan.durationMonths));
                                ...
                                <div className="mt-4 pt-4 border-t border-gray-100">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            ...
                                            className={`px-4 py-2 text-white rounded-lg font-medium disabled:opacity-50 ${selectedMember.status === 'EXPIRED' ? 'bg-orange-600 hover:bg-orange-700' : 'bg-slate-900 hover:bg-slate-800'}`}
                                        >
